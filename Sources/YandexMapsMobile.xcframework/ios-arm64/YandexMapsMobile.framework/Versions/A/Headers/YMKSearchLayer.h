...
/**
 * :nodoc:
 * Get experimental metadata of the last response.
 */
- (nullable YMKSearchExperimentalMetadata *)experimentalMetadata;
...
/**
 * Set the bitmap downloader. Do not use this method; it is for internal
 * use only.
 *
 ...
 *
 * @return s  Placemark identifier if any placemark is selected,
 * otherwise none.
 */
