...
public:
    ...
    virtual bool onClusterizedCollectionVisitStart(
        ::yandex::maps::mapkit::map::ClusterizedPlacemarkCollection* collection) override;

    virtual void onClusterizedCollectionVisitEnd(
        ::yandex::maps::mapkit::map::ClusterizedPlacemarkCollection* collection) override;
