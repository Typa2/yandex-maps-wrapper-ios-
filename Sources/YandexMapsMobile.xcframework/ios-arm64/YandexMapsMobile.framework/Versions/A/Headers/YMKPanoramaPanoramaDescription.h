...
typedef NS_ENUM(NSUInteger, YMKPanoramaArrowConnectionStyle) {
    ...
    /**
     * connection from street to indoor or from indor to street
     */
...
@interface YMKPanoramaPanoramaDescription : NSObject
