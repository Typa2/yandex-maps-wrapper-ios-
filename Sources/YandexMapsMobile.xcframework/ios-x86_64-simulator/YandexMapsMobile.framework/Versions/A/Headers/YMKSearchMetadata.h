...
#import <YandexMapsMobile/YMKSearchCollectionResponse.h>
...
/**
 * Additional info for the response from collection search.
 *
 * Optional field, can be nil.
 */
@property (nonatomic, readonly, nullable) YMKSearchCollectionResultMetadata *collectionResultMetadata;
...
+ (nonnull YMKSearchMetadata *)searchMetadataWithFound:( NSInteger)found
                              ...
                              collectionResultMetadata:(nullable YMKSearchCollectionResultMetadata *)collectionResultMetadata
