...
/**
 * :nodoc:
 * This method turns region into unsupported state. Only for testing.
 * NB: * region with Available state will be removed from regions list.
 * this change will have temporary effect. After receiving a new region
 * list from the server, region will return to its normal state.
 */
- (void)simulateUnsupportedWithRegionId:(NSUInteger)regionId;
